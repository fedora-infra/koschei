...
Vagrant.configure(2) do |config|
  ...
  config.vm.box_url = "http://download.eng.brq.redhat.com/pub/fedora/linux/releases/26/CloudImages/x86_64/images/Fedora-Cloud-Base-Vagrant-26-1.5.x86_64.vagrant-libvirt.box"
