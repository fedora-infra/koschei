...
def schedule_builds(db_session):
    ...
    manual_priority = db_session.query(Package.id, Package.manual_priority).subquery()
    static_priority = db_session.query(Package.id, Package.static_priority).subquery()
